/*
Crear un programa en C en donde se ingresen datos de clientes (dirección, correo, contacto, nombre), 
fecha de la última vez en que adquirió el servicio junto con el precio y descuentos individuales de
cada uno y cuando será la próxima vez que requerirá el servicio.
*/
